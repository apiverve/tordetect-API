# Tor Node Detector API - Examples

This folder contains example code for using the Tor Node Detector API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/tordetect', {
...
response = requests.get('https://api.apiverve.com/v1/tordetect',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/tordetect");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/tordetect](https://docs.apiverve.com/ref/tordetect)
